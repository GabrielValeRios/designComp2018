...
-- *****************************************************************************
-- Generated on "10/09/2017 17:21:00"
...
SIGNAL entradaULAB : STD_LOGIC_VECTOR(3 DOWNTO 0);
...
COMPONENT Relogio
	PORT (
	clk1 : IN STD_LOGIC;
	entradaULAB : IN STD_LOGIC_VECTOR(3 DOWNTO 0);
...
-- entradaULAB[3]
t_prcs_entradaULAB_3: PROCESS
BEGIN
	entradaULAB(3) <= '0';
WAIT;
END PROCESS t_prcs_entradaULAB_3;
-- entradaULAB[2]
t_prcs_entradaULAB_2: PROCESS
BEGIN
	entradaULAB(2) <= '0';
WAIT;
END PROCESS t_prcs_entradaULAB_2;
-- entradaULAB[1]
t_prcs_entradaULAB_1: PROCESS
BEGIN
	entradaULAB(1) <= '0';
WAIT;
END PROCESS t_prcs_entradaULAB_1;
-- entradaULAB[0]
t_prcs_entradaULAB_0: PROCESS
BEGIN
	entradaULAB(0) <= '0';
WAIT;
END PROCESS t_prcs_entradaULAB_0;
END Relogio_arch;
