...
-- *****************************************************************************
-- Generated on "10/16/2018 18:00:16"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          fluxoDadosALU
-- 
...
ENTITY fluxoDadosALU_vhd_vec_tst IS
END fluxoDadosALU_vhd_vec_tst;
ARCHITECTURE fluxoDadosALU_arch OF fluxoDadosALU_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL entradaA : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL entradaB : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL last_Cout : STD_LOGIC;
SIGNAL resposta : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL SEL_Inverte_SinalA : STD_LOGIC;
SIGNAL SEL_Inverte_SinalB : STD_LOGIC;
SIGNAL SEL_ULA : STD_LOGIC_VECTOR(1 DOWNTO 0);
SIGNAL Z : STD_LOGIC;
COMPONENT fluxoDadosALU
	PORT (
...
-- list connections between master ports and signals
	...
	last_Cout => last_Cout,
	resposta => resposta,
	SEL_Inverte_SinalA => SEL_Inverte_SinalA,
	SEL_Inverte_SinalB => SEL_Inverte_SinalB,
	SEL_ULA => SEL_ULA,
	Z => Z
	);
-- entradaA[31]
...
-- SEL_Inverte_SinalA
t_prcs_SEL_Inverte_SinalA: PROCESS
BEGIN
	SEL_Inverte_SinalA <= '0';
WAIT;
END PROCESS t_prcs_SEL_Inverte_SinalA;

-- SEL_Inverte_SinalB
t_prcs_SEL_Inverte_SinalB: PROCESS
BEGIN
	SEL_Inverte_SinalB <= '0';
WAIT;
END PROCESS t_prcs_SEL_Inverte_SinalB;
-- SEL_ULA[1]
